            ...
            <!-- Left Content -->
             <div class="text-center lg:text-left max-w-xl">
                <h1 class="text-4xl sm:text-5xl font-bold text-amber-950 leading-tight mb-4">
                    Temukan Penawaran Terbaik untuk Produk Unggulan
                </h1>
                <p class="text-gray-700 text-base sm:text-lg mb-6">
                    Diskon eksklusif dan Penawaran khusus untuk semua yang Anda sukai. 
                    Belanja Sekarang dan jadilah yang pertama mendapatkan tren terbaru
                </p>
